...
canonical-url: 'https://openrouter.ai/docs/guides/features/server-tools/web-search'
...
'og:image':
  type: url
  value: >-
    https://openrouter.ai/dynamic-og?pathname=features/server-tools/web-search&title=Web%20Search%20Server%20Tool&description=Real-time%20web%20search%20for%20any%20model
'og:image:width': 1200
'og:image:height': 630
...
_\* Exa: limit applies **per result**_
